...
# dc="docker run -v /home/rancher/stacks:/stack -v /tmp:/tmp -v /var/run/docker.sock:/var/run/docker.sock -w /tmp docker/compose"
dcr="$dc run --rm"
...
docker run -v /home/rancher/sentry:/sentry -v /tmp:/tmp -v /var/run/docker.sock:/var/run/docker.sock -w /tmp docker/compose -f /sentry/docker-compose.yml -p onpremise down --rmi local --remove-orphans
# $dc -p onpremise down --rmi local --remove-orphans
# This is for newer versions
docker run -v /home/rancher/sentry:/sentry -v /tmp:/tmp -v /var/run/docker.sock:/var/run/docker.sock -w /tmp docker/compose --rmi local --remove-orphans
